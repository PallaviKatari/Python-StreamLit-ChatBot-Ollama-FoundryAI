...
def main():
    ...
    try:
        ...
        api_version = os.getenv("API_VERSION")   # e.g. "2024-06-01"

    # Add api-version to the endpoint
        #base_url = f"{openai_endpoint}/openai/deployments/{model_deployment}?api-version={api_version}"
